            ...
            while($result = $user-> fetch_assoc()){ ?>
                                     ...
                                     <tr>
                                         ...
                                         <td class="text-center">
                                            ...
                                            <a href="edit.php?ed_id=<?php echo $result ['id']; ?>"><button class="btn btn-warning ">Update</button></a> 
   ...
   <?php  }else{
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if(isset($_FILES['image'])){
       ...
       if(empty($name) && empty($title) && empty($content) && empty($file_name)){
        echo "<span class='error'>Field must not be Empty</span>";
       }else{
        $query = "INSERT INTO user(name, title, content,image) VALUES ('$name','$title','$content','$file_name')";
                                         ...
                                         <div class="form-group  row">
                                            <label for="serial" class="col-xs-4 cus_lab">Name</label>
                                                 <div class="col-sm-8">
                                                   ...
                                                   <input type="text" class="form-control cus_input" name="name" placeholder="Enter Name"/>
                                       ...
                                       <div class="form-group  row">
                                            <label for="serial" class="col-xs-4 cus_lab"> post Content</label>
                                                 <div class="col-sm-8">
                                                   ...
                                                   <textarea name="content" id="" cols="38" rows="5" class="form-control cus_input" placeholder="post Content"></textarea>
                                        ...
                                        <div class="form-group  row">
                                            <label for="serial" class="col-xs-4 cus_lab"></label>
                                                ...
                                                <button type="submit" class="btn btn-success cut_btn" name="addPost">Add Post</button>
                                 ...
                                 <div class="col-xs-12 col-sm-5 col-md-5">
                                    <div class="form-group  row">
                                        <label for="serial" class="col-xs-4 cus_lab">Title</label>
                                            <div class="col-sm-8">
                                             ...
                                             <input type="text" class="form-control cus_input" name="title" placeholder="Title"/>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-8 cus_input">
                                             ...
                                             <input type="file" name="image"  placeholder="Image" class=" " />
